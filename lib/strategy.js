...
function Strategy(options, verify) {
  ...
  options.botPrompt = options.botPrompt || null;
  ...
  if (options.botPrompt && (options.botPrompt === 'normal' || options.botPrompt === 'aggressive'))
    options.authorizationURL += `&bot_prompt=${options.botPrompt}`;
